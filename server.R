...
unigram <- as.data.table(read.csv("./appdata/unigram.csv"))
bigram.s <- as.data.table(read.csv("./appdata/bigram.csv"))
trigram.s <- as.data.table(read.csv("./appdata/trigram.csv"))
quadgram.s <- as.data.table(read.csv("./appdata/quadgram.csv"))
pentagram.s <- as.data.table(read.csv("./appdata/pentagram.csv"))
